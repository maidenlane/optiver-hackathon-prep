...
class AutoTrader(BaseAutoTrader):
    ...
    def on_order_book_update_message(self, instrument: int, sequence_number: int, ask_prices: List[int],
        ...
        if instrument == Instrument.FUTURE:
            ...
            # Theoretical price = weighted average orderbook levels 1, 2, 3, 4 and 5.
            ...
            if self.action_count <= 14:
                ...
                if self.position > 0:
                    ...
                    elif self.position >= 65 and self.position < 100:
                ...
                # Correct negative bids (need to identify why and fix).
                ...
                if self.bid_id == 0 and self.new_bid_price != 0 and self.bid_volume != 0:
                    self.bid_id = self.last_bid_id = self._next(self.order_ids)
                ...
                if self.ask_id == 0 and self.new_ask_price != 0 and self.ask_volume != 0:
                    self.ask_id = self.last_ask_id = self._next(self.order_ids)
